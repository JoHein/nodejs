...
<form class="inscription" action="req_inscription.php" method="post" name="inscription">
    ...
    <ul>
        ...
        <li>
            ...
            <input type="text" name="nom" id="nom" placeholder="nom" value="<?=(isset($_GET['nom'])?$_GET['nom']:'')?>"/>
        </li>
        <li>
            <label for="prenom">Prénom :</label>
            <input type="text" name="prenom" id="prenom" required placeholder="prénom"  value="<?=(isset($_GET['prenom'])?$_GET['prenom']:'')?>"
            />
            <!-- ajouter à input l'attribut qui dit que c'est un champs obligatoire -->
        ...
        <li>
            ...
            <input type="tel" name="tel" id="tel"  placeholder="téléphone" value="<?=(isset($_GET['tel'])?$_GET['tel']:'')?>"/>
        </li>
        <li>
            <label for="website">Site internet :</label>
            <input type="url" name="website" id="website"  placeholder="site internet" value="<?=(isset($_GET['website'])?$_GET['website']:'')?>"/>
        </li>
        ...
        <li>
            ...
            <input type="date" name="birthdate" id="birthdate" placeholder="JJ/MM/AAAA" required onchange="computeAge()" value="<?=(isset($_GET['birthdate'])?$_GET['birthdate']:'')?>"/>
            <script>
        ...
        <li>
            ...
            <input type="text" name="ville" id="ville" value="<?=(isset($_GET['ville'])?$_GET['ville']:'')?>"/>
        </li>

        <li>
            <label for="taille">Taille : </label>
            <input type="range" name="taille" id="taille" min="0" max="2.50" step="0.01" value="<?=(isset($_GET['taille'])?$_GET['taille']:'')?>"/>
        </li>
        <li>
            <label for="couleur">Couleur :</label>
            <input type="color" name="couleur" id="couleur" value="<?=(isset($_GET['couleur'])?$_GET['couleur']:'black')?>"/>
        </li>
